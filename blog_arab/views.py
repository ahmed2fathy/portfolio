...
from category_arab.models import *
from category_arab.views import *
...
#-----------------------------------------------------------------------
    ...
    all_category = Category.objects.all().annotate(post_count=Count('post_category_ar'))
...
#------------------ فورم التعليقات  CommentForm ---------------
    if request.method == 'POST':
        ...
        if comment_form.is_valid():
            ...
            obj.save()
            return redirect('blog_arab:single_blog', slug=single_blog.slug)
