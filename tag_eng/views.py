...
#-----------------------------------------------------------------------
    ...
    context = {
        'article': Blog.objects.filter(tag_eng=get_object_or_404(Tag, slug=slug)),#المسئول عن جلب المقالات من التاجات
        ...
        'cate_top': Blog.objects.filter(tag_eng=get_object_or_404(Tag, slug=slug))[:1],
        'form': form,
    ...
    return render(request, "pages\_tag_eng_blog.html", context)
