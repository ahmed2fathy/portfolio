...
from category_eng.models import *
...
#--------------------دالة ترقيم الصفحات ---------------------------------
    paginator = Paginator(search, 4)  # Show 1 contacts per page.
...
#-----------------------------------------------------------------------
    ...
    all_category = Category.objects.all().annotate(post_count=Count('post_category_en'))
    ...
    context = {
        ...
        'top_blogs': Blog.objects.all()[1:2],
        'all_blogs': page_obj,
    ...
    return render(request, 'pages/blogs-en.html', context)
...
#------------------ فورم التعليقات  CommentForm ---------------
    if request.method == 'POST':
        ...
        if comment_form.is_valid():
            ...
            obj.save()
            return redirect('blog_eng:single_blog', slug=single_blog.slug)
...
#--------------------------------------------------------------------------------------
    ...
    context = {
        ...
        'name_wedgits': name_wedgits,
        'ads': ads,
        'blog_category': Blog.objects.all()[:1],
       'all_category': all_category,
       'banner_category': banner_category,
        'form': form,
       'all_tag': all_tag,
    ...
    return render(request, 'pages\single-blog-en.html', context)
