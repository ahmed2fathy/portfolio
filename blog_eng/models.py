...
from category_eng.models import Category
import index
...
import category_eng
import tag_eng
from tag_eng.models import Tag
...
class Blog(models.Model):
    ...
    author_en = models.ForeignKey(User, related_name='author_en',
                               default=User, on_delete=models.CASCADE, verbose_name=_(' author'))
    category_eng = models.ForeignKey(Category, related_name='post_category_en', on_delete=models.CASCADE,
                                      verbose_name=_(' category'))
    tag_eng = models.ForeignKey(Tag, related_name='post_tag_en', on_delete=models.CASCADE,
                                 verbose_name=_('tag'))
